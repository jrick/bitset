...
// Package bitset contains bitset implementations for bit packing binary
...
// On 64-bit machines, this can result in a bitset using about 64 times less
// memory to store the same values as a []bool.  While bitsets introduce
// bitshifting overhead for gets unnecessary for a []bool, they are usually
// still more performant than a []bool due to the smaller data structure
